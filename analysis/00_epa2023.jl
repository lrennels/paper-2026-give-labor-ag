...
scghgs |> save(joinpath(@__DIR__, "../output/epa2023/sc-$gas-$damages-$year-n$num_trials.csv"));
...
scghgs_mean |> save(joinpath(@__DIR__, "../output/epa2023/sc-$gas-$damages-$year.csv"));
